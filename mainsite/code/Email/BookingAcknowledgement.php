...
class BookingAcknowledgement extends Email
{
    ...
    public function __construct($booking = null)
    {
        ...
        $to                 =   empty($booking) ?
                                ...
                                $this->booking->Email;
        $subject            =   'Booking Confirmation for Consultation at Success Global';
        ...
        if ($this->booking->PassportBio()->exists()) {
            $this->attachFile($this->booking->PassportBio()->getRelativePath());
        }

        if ($this->booking->VisaLabel()->exists()) {
            $this->attachFile($this->booking->VisaLabel()->getRelativePath());
        }


        $this->setTemplate('BookingAcknowledgement');
