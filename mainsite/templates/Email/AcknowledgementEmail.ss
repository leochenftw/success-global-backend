...
<body yahoo="yahoo">
    <p style="height: 0; overflow: hidden; font-size: 0; line-height: 0;">Hi $FirstName, we have received your enquiry. We will get back to you shortly :)</p>
                                ...
                                <td class="main-container">
                                    ...
                                    <table class="alpha-center-table maintain-table-on-mobile" width="600" cellpadding="0" cellspacing="0">
                                        <tr class="align-vertical-center">
                                            ...
                                            <td class="col-right has-text-right">
                                    ...
                                    <table class="alpha-center-table maintain-table-on-mobile bg-white" width="600" cellpadding="0" cellspacing="0">
                                        <tr class="align-vertical-center">
                                            <td class="content has-text-left">
                                                <h2 class="title is-4">Dear <em>$FirstName</em></h2>
                                                <p>Thank you for contacting us! We've receive your enquiry, and we will get back to you shortly :)</p>
                                                <p>In the meantime while waiting, you are more than welcome to call us at: <br /><a href="tel:0508 484 727">0508 484 727</a>.<br /></p>
                                                <p class="subtitle is-7">Below is a copy of your enquiry:</p>
